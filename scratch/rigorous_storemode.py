...
N = 3
CONFIGS = {"recurrent": 31010, "rne": 31011, "sr": 31012, "ef": 31013}
    ...
    for rep_i in range(N):
        ...
        with cf.ThreadPoolExecutor(max_workers=len(problems)) as ex:
            ...
            for f in cf.as_completed(futs):
                ...
                rows.append(rec)
        json.dump(rows, open(f"scratch/rigorous_storemode_{name}.json", "w"))
...
def main():
    ...
    json.dump(out, open("scratch/rigorous_storemode_all.json", "w"))
    print("\n========== STORE-MODE A/B (winner = lowest loops + highest acc) ==========")
    ...
    print("raw -> scratch/rigorous_storemode_all.json")
