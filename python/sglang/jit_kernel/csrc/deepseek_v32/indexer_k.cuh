...
template <typename DType, typename PosT, bool kUsePDL, int32_t kPageBits, bool kIsNeox, bool kIsFp4>
...
template <typename DType, bool kUsePDL, uint32_t kPageSize, bool kIsNeox, bool kIsFp4 = false>
struct FusedKIndexerNormRopeStoreKernel {
  ...
  template <typename PosT>
  static constexpr auto kernel = fused_k_indexer_norm_rope_store<DType, PosT, kUsePDL, kPageBits, kIsNeox, kIsFp4>;
